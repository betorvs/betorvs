...
func main() {
	Repositories = []string{"sonarqube-to-gitlab-webhook", "event-logger", "sensu-opsgenie-handler", "sensu-hangouts-chat-handler", "sensu-alertmanager-events", "sensu-grafana-mutator", "sensu-dynamic-check-mutator", "sensu-kubernetes-events", "secretreceiver", "secretpublisher"}
	var repos []string
